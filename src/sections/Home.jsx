...
import Avatorr from "../assets/Avatorr.png";
...
export default function Home() {
  ...
  return (
    <section
      id="home"
      className="w-full min-h-screen relative bg-gray-800 overflow-hidden "
    >
      <ParticlesBackground />
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-0
           w-[60vw] sm:w-[50vw] md:w-[40vw]
           h-[60vw] sm:h-[50vw] md:h-[40vw]
           max-w-[500px] max-h-[500px]
           rounded-full bg-linear-to-r 
           from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
           opacity-30 sm:opacity-20 md:opacity-10
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-start h-full text-center lg:text-left">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
              ...
              seamless user experiences using JavaScript, React, and Node.js.
            </motion.p>
            ...
            >
              <a
                ...
                bg-linear-to-r from-[#4af360] via-[#22c49b] to-[#4040f0]
                shadow-lg hover:scale-105 transition-all hover:text-black"
              >
                View My Work
              </a>
              ...
              <a
                href="/Resume.pdf"
                download
                className="px-6 py-3 rounded-full text-lg font-medium text-gray-900 bg-white 
                hover:bg-gray-300 shadow-lg hover:scale-105 transition-all"
              >
                My Resume
              </a>
            </motion.div>
